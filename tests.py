...
class TestCasesTheInternetHerokuapp(unittest.TestCase):
    ...
    def test_add_remove_element(self):
        ...
        self.assertEqual(False, self.action.does_element_exist(
            self.action.driver.find_elements_by_class_name('added-manually')), 'Button should not exist.')
    ...
    def test_checkboxes(self):
        ...
        self.assertEqual(True, self.action.driver.find_element_by_xpath(checkboxes_input1).is_selected(),
    ...
    def test_forgot_password(self):
        ...
        self.assertEqual("Your e-mail's been sent!",
                         self.action.driver.find_element_by_xpath(forgot_password_confirmation).text,
                         "Something is wrong!")
    ...
    def test_search_for_typo(self):
        ...
        self.assertEqual('This example demonstrates a typo being introduced. It does it randomly on each page load.',
                         self.action.driver.find_element_by_xpath(text_to_check_first_line).get_attribute('outerText'),
                         'Typo detected!')
        self.assertEqual("Sometimes you'll see a typo, other times you won't.",
                         self.action.driver.find_element_by_xpath(text_to_check_second_line).get_attribute('outerText'),
                         'Typo detected!')

    def test_file_upload(self):
        self.action.upload_file()
        self.assertEqual('test_file.jpg',
                         self.action.driver.find_element_by_xpath(file_upload_result).get_attribute('innerText'),
                         'Upload failed!')
